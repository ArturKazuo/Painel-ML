...
function ifApto(responses){

    if(responses?.apto){
        return ('Apartamento: ' + responses.apto + '\n')
    }
    else {
        return '';
    }
...
function ifBloco(responses){

    if(responses?.bloco){
        return ('Bloco: ' + responses.bloco + '\n')
    }else {
        return '';
    }
...
function ifAla(responses){

    if(responses?.ala){
        return ('Ala: ' + responses.ala + '\n')
    }else {
        return '';
    }
